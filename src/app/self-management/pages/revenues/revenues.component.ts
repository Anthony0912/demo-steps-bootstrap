...
export class RevenuesComponent implements OnInit {
  ...
  @Output() handleOnEmitterRevenues: EventEmitter<SelfManagement> = new EventEmitter<SelfManagement>();
  ...
  public onSubmit(): void {
    ...
    this.handleOnEmitterRevenues.emit({
      lastStep: 5,
      stepSelected: 5,
      revenues: { name: this.name.value.trim() }
    })
    this.myForm.reset();
  }
